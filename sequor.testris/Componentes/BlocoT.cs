...
{
    public class BlocoT : absBloco
    {
        public BlocoT(Enums.TiposAngulo tipoAngulo)
        {
            Cor = Color.Maroon;
                ...
                case Enums.TiposAngulo._0:
                    {
                        ...
                        {
                            Blocos[0].Location = new Point(Blocos[1].Location.X + 50, Blocos[1].Location.Y + 0);
                            Blocos[1].Location = new Point(Blocos[1].Location.X + 25, Blocos[1].Location.Y + 0);
                            Blocos[2].Location = new Point(Blocos[1].Location.X - 25, Blocos[1].Location.Y + 0);
                            Blocos[3].Location = new Point(Blocos[1].Location.X, Blocos[1].Location.Y + 25);
                        }
                ...
                case Enums.TiposAngulo._90:
                    {
                        ...
                        {
                            Blocos[0].Location = new Point(Blocos[1].Location.X + 25, Blocos[1].Location.Y);
                            Blocos[1].Location = new Point(Blocos[1].Location.X, Blocos[1].Location.Y);
                            Blocos[2].Location = new Point(Blocos[1].Location.X - 25, Blocos[1].Location.Y);
                            Blocos[3].Location = new Point(Blocos[1].Location.X, Blocos[1].Location.Y + 25);
                        }


                        TipoAngulo = Enums.TiposAngulo._180;

                        break;
                    }
                case Enums.TiposAngulo._180:
                    {
                        if (Blocos.Count == 0)
                        {
                            Blocos = new List<Bloco>
                        ...
                        else
                        {
                            ...
                            Blocos[3].Location = new Point(Blocos[1].Location.X - 25, Blocos[1].Location.Y + 0);
                        }
                        TipoAngulo = Enums.TiposAngulo._270;
                        break;
                    }
                case Enums.TiposAngulo._270:
                    {
